      ...
      {tags.length > 0 && (
        <div className="flex flex-wrap items-center gap-2">
          {tags.map((tag, index) => (
            <span
              key={index}
              className={`relative flex max-w-48 cursor-default items-center justify-center rounded-full border border-primary-100 bg-primary-50 py-2 pl-3 ${disabled ? "pr-3" : "pr-10"}`}
            >
